...
it can used to modify, change,acceses the data
...
2.We will cover different examples to find the index of element in list using Pythonand explore different scenarios while using list
 index() method, such as: See more
""" 
